...
export default function NewHaircut({ subscription, count }: NewHaircutProps) {
  ...
  async function handleRegister(){
    ...
    try {
      ...
      alert('Erro ao cadastrar modelo de corte')
    }
  }
    ...
    <>
      ...
      <Sidebar>
        <Flex direction="column" alignItems="flex-start" justifyContent="flex-start">
          ...
          >
            <Link href="/haircuts">
              <Button p={4} display="flex" alignItems="center" justifyItems="center" mr={4} bg="gray.700" _hover={{ background: "gray.700" }} color="white">
