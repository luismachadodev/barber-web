  ...
  return(
    <Box minH="100vh" bg="barber.900">
      <SidebarContent
       ...
       />
       <Drawer autoFocus={false} isOpen={isOpen} placement="left" returnFocusOnClose={false} onOverlayClick={onClose} size="full" onClose={onClose}>
          <DrawerContent>
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  return (
    <Box bg="barber.400" borderRight="1px" borderRightColor={"whiteAlpha.300"} w={{ base: 'full', md: 60 }} pos="fixed" h="full" {...rest}>
  ...
  return(
    ...
    >
      ...
      <Flex flexDirection="row">
        <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold" ml={8}>Barber</Text>
        <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold" color="button.cta">PRO</Text>
      </Flex>
